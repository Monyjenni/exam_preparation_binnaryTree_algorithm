...
namespace binarytree_CSharp
{
  internal class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.WriteLine("A BST by Chansovanmony Yoeun (no duplicate allowed).");
      while (choice != 'q')               //interact with user
      {                                   //until user types 'q'
        Console.WriteLine("Enter first letter of your choice.");
        Console.WriteLine("show, insert, find, traverse ,zFindMax or quit.");
        ...
        switch (choice)
        {
          ...
          case 'f':                        //find a node
            ...
            break;
            case 'z':
                 //we store in maxValue coz we gotta print those value outta function
                int maxInteger = theTree.zFindMax();
                Console.WriteLine("The Max is :", maxInteger);
            break;
